...
add_interface_port avalon_slave_1 dataa writebyteenable_n Input 32
add_interface_port avalon_slave_1 datab writebyteenable_n Input 32
add_interface_port avalon_slave_1 clk_en beginbursttransfer Input 1
add_interface_port avalon_slave_1 enable response Output 1
add_interface_port avalon_slave_1 dataout readdata Output 8
